...
return [
    ...
    'columns' => [
        'tt_content' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ucph_ce_slider/Resources/Private/Language/locallang_be.xlf:ucph_ce_slider_item.tt_content',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tt_content',
                'foreign_table_where' => 'AND tt_content.pid=###CURRENT_PID### AND tt_content.{#CType}=\'ucph_ce_slider\'',
                'maxitems' => 1,
                'default' => 0,
            ],
        ],
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_ucph_ce_slider_item.pid=###CURRENT_PID### AND tx_ucph_ce_slider_item.sys_language_uid IN (-1,0)',
                'default' => 0
            ]
        ],
        'l10n_diffsource' => [
